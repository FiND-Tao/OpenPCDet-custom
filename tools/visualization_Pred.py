...
pred_b=np.load('/data/taoliu/Sri/point_detection/OpenPCDet/tools/UK sample plot6_slice_0_15x15_Grid_1.npy')
#label="/data/taoliu/Sri/point_detection/OpenPCDet/data/stem/training/labels/Tech_Slice_1N_10x10_Grid_5_recent.txt"
